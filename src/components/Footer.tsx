...
function Footer() {
  ...
  <nav>
    ...
    <a className="link link-hover">Electrics</a>
    <a className="link link-hover">Security Systems</a>
    <a className="link link-hover">⁠Smart Home</a>
  </nav>
  <nav>
    <h6 className="footer-title">Values</h6>
    <a className="link link-hover">⁠Innovation</a>
    <a className="link link-hover">⁠Quality</a>
    <a className="link link-hover">⁠Customer Focus</a>
